...
#  endif
   ...
   SUBROUTINE Agrif_Update_vvl( )
      ...
      !
#if defined key_qco
      ! TBD: Suppress update along dynamical interface ! 
      ...
      CALL Agrif_Update_Variable(e3u_id, procname=updatee3u) 
      CALL Agrif_Update_Variable(e3v_id, procname=updatee3v) 
      CALL Agrif_Update_Variable(e3f_id, procname=updatee3f) 
      l_vremap                      = .FALSE. 
      !
      ! TBD: Suppress update along dynamical interface ! 
!      CALL Agrif_ChildGrid_To_ParentGrid()
...
! VERTICAL REFINEMENT END
...
#if ! defined key_qco   &&   ! defined key_linssh
   SUBROUTINE updatee3t(tabres, i1, i2, j1, j2, k1, k2, before )
      !!---------------------------------------------
      !!           *** ROUTINE updatee3t ***
      !!---------------------------------------------
   ...
   SUBROUTINE updatee3u(tabres, i1, i2, j1, j2, k1, k2, before )
      !!---------------------------------------------
      !!           *** ROUTINE updatee3u ***
      !!---------------------------------------------
      REAL(wp), DIMENSION(i1:i2,j1:j2,k1:k2), INTENT(inout) :: tabres 
      ...
      ELSE 
         !
!         WHERE( tabres(i1:i2,j1:j2,k1:k2)<1.e-6_wp ) tabres(i1:i2,j1:j2,k1:k2) = e3u_0(i1:i2,j1:j2,k1:k2)
         WHERE( umask(i1:i2,j1:j2,k1:k2) == 0._wp ) tabres(i1:i2,j1:j2,k1:k2) = e3u_0(i1:i2,j1:j2,k1:k2)
         !
         ! 1) Updates at BEFORE time step:
         ! -------------------------------
         !
         ! Save "old" scale factor (prior update) for subsequent asselin correction
         ! of prognostic variables
         e3u(i1:i2,j1:j2,k1:k2,Krhs_a) = e3u(i1:i2,j1:j2,k1:k2,Kmm_a)
               ...
               DO jj=j1,j2
                  DO ji=i1,i2
                     e3u(ji,jj,jk,Kbb_a) =  e3u(ji,jj,jk,Kbb_a) &
                           & + rn_atfp * ( tabres(ji,jj,jk) - e3u(ji,jj,jk,Kmm_a) )
                  END DO
               END DO
            END DO
            !
         ...
         e3u(i1:i2,j1:j2,k1:k2,Kmm_a) = tabres(i1:i2,j1:j2,k1:k2)
         !
         ! Update total depth:
         ...
         !
         IF  ((l_1st_euler).AND.(Agrif_Nb_Step()==0) ) THEN
            e3u (i1:i2,j1:j2,k1:k2,Kbb_a)  = e3u (i1:i2,j1:j2,k1:k2,Kmm_a)
            e3uw(i1:i2,j1:j2,k1:k2,Kbb_a)  = e3uw(i1:i2,j1:j2,k1:k2,Kmm_a)
      ...
      ENDIF
      !
   END SUBROUTINE updatee3u


   SUBROUTINE updatee3v(tabres, i1, i2, j1, j2, k1, k2, before )
      !!---------------------------------------------
      !!           *** ROUTINE updatee3v ***
      !!---------------------------------------------
      REAL(wp), DIMENSION(i1:i2,j1:j2,k1:k2), INTENT(inout) :: tabres 
      ...
      ELSE 
         !
!         WHERE( tabres(i1:i2,j1:j2,k1:k2) < 1.e-6 ) tabres(i1:i2,j1:j2,k1:k2) = e3v_0(i1:i2,j1:j2,k1:k2)
         WHERE( vmask(i1:i2,j1:j2,k1:k2) == 0._wp ) tabres(i1:i2,j1:j2,k1:k2) = e3v_0(i1:i2,j1:j2,k1:k2)
         !
         ! 1) Updates at BEFORE time step:
         ! -------------------------------
         !
               ...
               DO jj=j1,j2
                  DO ji=i1,i2
                     e3v(ji,jj,jk,Kbb_a) =  e3v(ji,jj,jk,Kbb_a) &
                           & + rn_atfp * ( tabres(ji,jj,jk) - e3v(ji,jj,jk,Kmm_a) )
                  END DO
               END DO
            END DO
            !
         ...
         !
         ! Update vertical scale factor at U-points:
         e3v(i1:i2,j1:j2,k1:k2,Kmm_a) = tabres(i1:i2,j1:j2,k1:k2)
         !
         ! Update total depth:
         ...
         !
         IF  ((l_1st_euler).AND.(Agrif_Nb_Step()==0) ) THEN
            e3v  (i1:i2,j1:j2,k1:k2,Kbb_a)  = e3v  (i1:i2,j1:j2,k1:k2,Kmm_a)
            e3vw (i1:i2,j1:j2,k1:k2,Kbb_a)  = e3vw (i1:i2,j1:j2,k1:k2,Kmm_a)
      ...
      ENDIF
      !
   END SUBROUTINE updatee3v


   SUBROUTINE updatee3f(tabres, i1, i2, j1, j2, k1, k2, before )
      !!---------------------------------------------
      !!           *** ROUTINE updatee3f ***
      !!---------------------------------------------
      REAL(wp), DIMENSION(i1:i2,j1:j2,k1:k2), INTENT(inout) :: tabres 
      ...
      ELSE 
         !
!         WHERE( tabres(i1:i2,j1:j2,k1:k2) < 1.e-6 ) tabres(i1:i2,j1:j2,k1:k2) = e3f_0(i1:i2,j1:j2,k1:k2)
         WHERE( fe3mask(i1:i2,j1:j2,k1:k2) == 0._wp ) tabres(i1:i2,j1:j2,k1:k2) = e3f_0(i1:i2,j1:j2,k1:k2)
         !
         ! Update vertical scale factor at F-points:
         e3f(i1:i2,j1:j2,k1:k2) = tabres(i1:i2,j1:j2,k1:k2)
         !
      ENDIF
      !
   END SUBROUTINE updatee3f
#endif
